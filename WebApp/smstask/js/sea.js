...
function AddNewTab(id,name,gourl,isTreeMenu){
 ...
 function openTab(id,name,gourl,isTreeMenu){
        ...
        if(gourl.indexOf("http:")<0){
            gourl = ((sysConfig.isDebug?sysConfig.viewPath:"")+ gourl)
        }
        ...
        if(opens && opens.length>0 )
        {
            for (var i = 0; i < opens.length; i++) {
                if(opens[i].id == id && opens[i].title == name){                   
                    ...
                    menutabs.tabpanels[i].content='<div class="divFrame"><iframe id=bjiframe'+id+' style="width:100%; height:1000px;" src="'+gourl+'"></iframe></div>'
                    return false;
                }
            };
        }
        ...
        var curpage = {
            ...
            title: name,
            removable: true,
            content: '<div class="divFrame"><iframe id=bjiframe'+id+' style="width:100%; height:1000px;" src="'+gourl+'"></iframe></div>'
        }
...
// loading @chunlei
function LoadingFn () {
    if ($('#LoadingArea').length) return false;
    var createNode = document.createElement("div");
    createNode.innerHTML='<div id="LoadingArea" ms-controller="LoadingArea"><div ms-widget="loading, $loading, $loadOpts"></div></div>'
    ...
    avalon.scan(document.body, LoadingArea);
    return avalon.vmodels.$loading
}