...
define( function(require) {
    ...
    if (sysConfig.jsTracking) avalon.log('seajs-Tracking："checkboxlist---复选框列表"'); //
    require("A-common-css");
    require("A-checkboxlist-css");
    var template = require("text!../libs/model/avalon.checkboxlist.html");
