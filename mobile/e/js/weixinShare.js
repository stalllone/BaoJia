(function(c) {
    ...
    var b = function() {
        var f = {},
            j, g;
        for (var h = 0, e = arguments.length; h < e; h++) {
            j = arguments[h];
            if (typeof j === "object") {
                for (g in j) {
                    j[g] && (f[g] = j[g])
    ...
    var a = function(i, h, g) {
        ...
        var e = function(j) {
            switch (true) {
                case /\:cancel$/i.test(j.err_msg):
                    g.cancel && g.cancel(j);
                    break;
                case /\:(confirm|ok)$/i.test(j.err_msg):
                    g.confirm && g.confirm(j);
                    break;
                case /\:fail$/i.test(j.err_msg):
                default:
                    g.fail && g.fail(j);
                    break
            }
        ...
        WeixinJSBridge.on(i.menu, function(k) {
    ...
    d.getNetworkType = function(e) {
        if (e && typeof e == "function") {
            WeixinJSBridge.invoke("getNetworkType", {}, function(f) {
                e(f.err_msg)
            })
        }
    };
    d.closeWindow = function(e) {
        e = e || {};
        WeixinJSBridge.invoke("closeWindow", {}, function(f) {
            switch (f.err_msg) {
                    ...
                    WeixinJSBridge[j] = function() {
                        try {
                            var k = arguments.length > 0 ? arguments[0] : {},
                                l = k.__params ? k.__params.__runOn3rd_apis || [] : [];
                            ["menu:share:timeline", "menu:share:appmessage", "menu:share:weibo", "menu:share:qq", "general:share"].forEach(function(n) {
