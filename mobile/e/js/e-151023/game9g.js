...
Game9G.prototype.init = function() {
	...
	this.homeurl = "http://w.wekua.com/yjgz.php?wx=zg_abc_123";
	this.gzurl = "http://w.wekua.com/yjgz.php?wx=zg_abc_123";
	this.shareDomain = this.shareDomains[parseInt(Math.random() * this.shareDomains.length)];
	this.shareData.imgurl = "http://x.wekua.com/fkcsg/images/share_icon.png";
	this.shareData.link = "http://x.wekua.com/fkcsg/";
